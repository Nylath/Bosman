...
export const organizationBranding = {
  appName:
    getEnvText(import.meta.env.VITE_APP_NAME) ??
    "Bosman",
  ...
  loginTitle:
    getEnvText(import.meta.env.VITE_LOGIN_TITLE) ??
    "Dostęp kursanta",
  ...
  homeTitle:
    getEnvText(import.meta.env.VITE_HOME_TITLE) ??
    "Próbne egzaminy żeglarskie",
